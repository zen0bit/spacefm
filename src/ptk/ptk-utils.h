...
#define PTK_STOCK_MENU_ITEM(id, cb)                \
    {                                              \
        id, NULL, G_CALLBACK(cb), 0, 0, NULL, NULL \
    }
#define PTK_MENU_ITEM(label, cb, key, mod)                \
    {                                                     \
        label, NULL, G_CALLBACK(cb), key, mod, NULL, NULL \
    }
#define PTK_CHECK_MENU_ITEM(label, cb, key, mod)              \
    {                                                         \
        label, (char*)1, G_CALLBACK(cb), key, mod, NULL, NULL \
    }
#define PTK_RADIO_MENU_ITEM(label, cb, key, mod)              \
    {                                                         \
        label, (char*)2, G_CALLBACK(cb), key, mod, NULL, NULL \
    }
#define PTK_IMG_MENU_ITEM(label, icon, cb, key, mod)      \
    {                                                     \
        label, icon, G_CALLBACK(cb), key, mod, NULL, NULL \
    }
#define PTK_POPUP_MENU(label, sub)         \
    {                                      \
        label, NULL, NULL, 0, 0, sub, NULL \
    }
#define PTK_POPUP_IMG_MENU(label, icon, sub) \
    {                                        \
        label, icon, NULL, 0, 0, sub, NULL   \
    }
#define PTK_SEPARATOR_MENU_ITEM                \
    {                                          \
        NULL, (char*)(-1), NULL, 0, 0, NULL, 0 \
    }
#define PTK_MENU_END \
    {                \
        0            \
...
#define PTK_STOCK_TOOL_ITEM(id, cb)                \
    {                                              \
        id, NULL, NULL, G_CALLBACK(cb), NULL, NULL \
    }
#define PTK_TOOL_ITEM(label, icon, tooltip, cb)          \
    {                                                    \
        label, icon, tooltip, G_CALLBACK(cb), NULL, NULL \
    }
#define PTK_CHECK_TOOL_ITEM(label, icon, tooltip, cb)                    \
    {                                                                    \
        label, icon, tooltip, G_CALLBACK(cb), (PtkMenuItemEntry*)1, NULL \
    }
#define PTK_RADIO_TOOL_ITEM(label, icon, tooltip, cb)                    \
    {                                                                    \
...
#define PTK_SEPARATOR_TOOL_ITEM          \
    {                                    \
