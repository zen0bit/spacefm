...
static void exo_cell_renderer_ellipsized_text_get_preferred_height_for_width(
    GtkCellRenderer* renderer, GtkWidget* widget, int width, int* minimal_size, int* natural_size);
#endif
                                                       ...
                                                       int* height)
{
    ...
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)
          ->get_preferred_width)(renderer, widget, &text_width, NULL);
    (*GTK_CELL_RENDERER_CLASS(exo_cell_renderer_ellipsized_text_parent_class)
                                                                  ...
                                                                  int* natural_size)
{
    ...
    exo_cell_renderer_ellipsized_text_get_size(renderer,
                                               widget,
                                               NULL,
                                               NULL,
                                               NULL,
    ...
    GtkCellRenderer* renderer, GtkWidget* widget, int width, int* minimal_size, int* natural_size)
{
    ...
    exo_cell_renderer_ellipsized_text_get_preferred_height(renderer,
                                                           widget,
                                                           minimal_size,
                                                           natural_size);
}
 ...
 *
 * Creates a new #ExoCellRendererEllipsizedText. Adjust rendering parameters using gobject
 *properties, which can be set globally via g_object_set(). Also, with #GtkCellLayout and
 *#GtkTreeViewColumn, you can bind a property to a value in a #GtkTreeModel.
 *
