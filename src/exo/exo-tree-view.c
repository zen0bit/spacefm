...
static void exo_tree_view_get_property(GObject* object, uint prop_id, GValue* value,
                                       GParamSpec* pspec);
static void exo_tree_view_set_property(GObject* object, uint prop_id, const GValue* value,
                                       GParamSpec* pspec);
